...
{
    /// <inheritdoc />
<<<<<<<< HEAD:HoteleriaApp.Infrastructure.Persistence/Migrations/20260322193409_MigracionInicial.cs
    public partial class MigracionInicial : Migration
========
    public partial class HirokiUpdate : Migration
>>>>>>>> 40e2638 (Agrega precision a TipoHabitacion y actualizar ModuloPiso):HoteleriaApp.Infrastructure.Persistence/Migrations/20260324145859_HirokiUpdate.cs
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nombre = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Descripcion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CapacidadMax = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrecioBasePorNoche = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoHabitacionId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Habitacion_TiposHabitacion_TipoHabitacionId1",
                        column: x => x.TipoHabitacionId1,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reserva_Categoria_CategoriaId",
                        column: x => x.CategoriaId,
                        principalTable: "Categoria",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Habitacion_TipoHabitacionId1",
                table: "Habitacion",
                column: "TipoHabitacionId1");
